...
## Release status
- Version: 1.0.0
- GitHub-ready initial release package
...
## Migration policy
`v100` is the frozen initial migration for the first public release.
...
- EXIF orientation is normalized for JPEG uploads when supported
- Thumbnails are generated automatically

## Screenshots
Suggested repository assets:
- `screenshots/ucp-overview.png`
- `screenshots/profile-panel.png`
- `screenshots/post-slider.png`
